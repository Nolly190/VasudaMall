...
namespace VasudaDataAccess.Data_Access.Implementation
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(DbContext context)
        {
            ...
            DomesticItemTable = new DomesticItemTableRepo(context);
            ShippingItemTable = new ShippingItemTableRepo(context);
            ItemsTable = new ItemsTableRepo(context);
            ShippingChargeTable = new ShippingChargeTableRepo(context);
        }
        ...
        public IDomesticItemTable DomesticItemTable { get; }
        public IShippingItemTable ShippingItemTable { get; }
        public IItemsTable ItemsTable { get; }
        public IShippingChargeTable ShippingChargeTable { get; }
